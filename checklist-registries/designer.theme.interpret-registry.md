...
| T016 | Typography | Какой tracking policy для каждого typographic role? | Для display, body, mono и акцентных text roles самостоятельно выбрать negative, zero или positive tracking и дать rationale | Reference, Desired_character, Avoid, font metrics, readability, hierarchy | REPRESENTABLE / DATA_GAP / N_A | Нет данных о font metrics/readability или нет rationale для выбранного tracking — DATA_GAP. Positive display tracking и любой другой обоснованный выбор допустимы |
...
| T022 | Spacing | Какой density-mode у темы? | Compact / balanced / airy / editorial как описание общей плотности; density-mode не вычисляет line-height, margins или section spacing автоматически | Audience, Desired_character, Avoid, Business_type, Reference, content density | REPRESENTABLE / DATA_GAP / N_A | — |
| T023 | Spacing | Какой section rhythm? | Расстояния между крупными секциями и ритмические паузы как отдельное решение, согласованное с typography, content density и visual character | T022, Desired_character, Avoid, Reference, Site_context | REPRESENTABLE / DATA_GAP / N_A | Нет rationale или недостаточно данных о content density/site context — DATA_GAP |
| T024 | Spacing | Какой inline rhythm (line-height-mode для body)? | Плотный / нормальный / увеличенный как самостоятельное решение по readability, font metrics, content density и hierarchy, а не автоматическое следствие density-mode | T012, T022, font metrics, readability, content density | REPRESENTABLE / DATA_GAP / N_A | Нет rationale или недостаточно данных о body font/readability — DATA_GAP |
...
| T043 | Effects | Какой visual contrast? | Low / medium / high как описание общего визуального режима; выбрать его самостоятельно и отдельно проверить достаточный contrast текста и интерактивных элементов | Desired_character, Avoid, Reference, Brand_constraints, hierarchy, readability | REPRESENTABLE / DATA_GAP / N_A | Low/medium/high не определяют accessibility и не закреплены за business/character labels. Недостаточный contrast конкретных сочетаний корректируется по T009; недостаток данных или rationale — DATA_GAP |
