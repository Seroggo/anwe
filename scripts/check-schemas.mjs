...
const fixtures = [
  ...
  { name: 'fixture visible-service-selection MachineSpec input', schemaPath: 'schemas/input/site.machine.build.json', dataPath: 'tests/fixtures/machine-spec/fixture-visible-service-selection-input.json' },
  ...
  { name: 'fixture visible-service-selection MachineSpec output', schemaPath: 'schemas/output/site.machine.build.json', dataPath: 'tests/fixtures/machine-spec/fixture-visible-service-selection-output.json' },
...
const outputFixtures = new Map([
  ...
  ['tests/fixtures/machine-spec/fixture-visible-service-selection-output.json', 'contracts/machine-spec.schema.json'],
